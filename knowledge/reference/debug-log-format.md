...
- [VS Code Copilot Extension](../concepts/vscode-copilot-extension.md) — Where logs are stored
- [Subagent Cost Tracking](../concepts/subagent-cost-tracking.md) — How subagent files correlate
